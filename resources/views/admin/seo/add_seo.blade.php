                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-fullname">product Seo title</label>
                            ...
                            <div class="mb-3">
                                <label class="form-label" for="basic-default-upload-file">product Seo image</label>
                            ...
                            <label class="col-sm-2 col-form-label" for="basic-default-message">Seo Description</label>
                            <div class="row mb-3">
                                <div class="col-sm-10">
