            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('all_brand') }}" class="menu-link">
                                    <div data-i18n="All Coupon">All Coupon</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul class="menu-sub">
                            ...
                            <li class="menu-item">
                                <a href="{{ route('allBlog') }}" class="menu-link">
                                    <div data-i18n="All Blog">All Blog</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item">
                        <a href="" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons ti ti-layout-sidebar"></i>
                            <div data-i18n="Site Sitting"> Site Setting </div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="{{ route('siteSystem') }}" class="menu-link">
                                    <div data-i18n="Site Sitting">Site Sitting</div>
                                </a>
                            </li>
                        </ul>
                    </li>
